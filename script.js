...
const ringWin = new Audio("./assets/win.mp3");
ringWin.volume = 0.5;

// Son lors d'un crash sur un tuyau
const ringLoose = new Audio("./assets/loose.mp3");
ringLoose.volume = 0.6;

// Son lors de la chute de l'oiseau
const ringFall = new Audio("./assets/falling2.mp3");
ringFall.volume = 0.2;

// Son de l'ambiance du jeu
const bgMusic = new Audio("./assets/game_sound.mp3");
